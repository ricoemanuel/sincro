...
function(t, e) {
	...
	return function(t) {
		...
		Object.defineProperty(e, "__esModule", {
			...
			return "object" == typeof t ? ("number" == typeof t.vertical && (t.top = t.vertical, t.bottom = t.vertical), "number" == typeof t.horizontal && (t.right = t.horizontal, t.left = t.horizontal), {
				left : null !== (n = t.left) && void 0 !== n ? n : e, top: null !== (o = t.top) && void 0 !== o ? o : e,
	...
	default = function(t, e, n, o, r) {
			...
			return "justify" === o.halign ? r.text(t, e, n, {
				maxWidth : o.maxWidth || 100, align: "justify"
			}): r.text(t, e, n),
			r
		}
	}, function(t, e, n) {
		...
		function c(t, e, n, o, r, l, s) {
			...
			if (n.canEntireRowFit(u, s)) h(t, e, n, l, s);
				...
				h(t, e, n, l, s), p(t, e, r, l, s), c(t, e, f, o, r, l, s)
			} else p(t, e, r, l, s), c(t, e, n, o, r, l, s)
		}
		...
		function p(t, e, n, o, i) {
			...
			r.addTableBorder(t, e, n, o), g(t), e.pageNumber++, e.pageCount++, o.x = l.left, o.y = l.top, "everyPage" === e.settings.showHead && e.head.forEach((function(n) {
				return h(t, e, n, o, i)
			}))
		}
		function g(t) {
		...
		e.drawTable = function(t, e) {
			...
			var v = a.assign({}, s);
			e.startPageNumber = y.pageNumber(), !0 === n.horizontalPageBreak ?
			function(t, e, n, o) {
				u.
			default.calculateAllColumnsCanFitInPage(t, e).map((function(r, i) {
				...
				return h(y, e, t, s, e.columns)
			})), y.applyStyles(y.userStyles), e.body.forEach((function(t, n) {
				var o = n === e.body.length - 1;
				c(y, e, t, o, v, s, e.columns)
			})), y.applyStyles(y.userStyles), "lastPage" !== n.showFoot && "everyPage" !== n.showFoot || e.foot.forEach((function(t) {
				return h(y, e, t, s, e.columns)
			}))), r.addTableBorder(y, e, v, s), e.callEndPageHooks(y, s), e.finalY = s.y, t.lastAutoTable = e, t.previousAutoTable = e, t.autoTable && (t.autoTable.previous = e), y.applyStyles(y.userStyles)
		}, e.addPage = p
	}, function(t, e, n) {
		"use strict";
		var o, r = this && this.__extends || (o = function(t, e) {
			...
			return e.map((function(e, s) {
				for (var u = 0, c = {}, h = 0, f = 0, p = 0, g = n; p < g.length; p++) {
					...
					if (null == a[y.index] || 0 === a[y.index].left) if (0 === f) {
						var v = void 0,
							m = {};
						"object" != typeof(v = Array.isArray(e) ? e[y.index - h - u] : e[y.dataKey]) || Array.isArray(v) || (m = (null == v ? void 0 : v.styles) || {});
		...
		Object.defineProperty(e, "__esModule", {
			value: !0
		}), e.Cell = e.Column = e.Row = e.Table = e.CellHookData = e.__drawTable = e.__createTable = e.applyPlugin = void 0;
		var o = n(12),
			r = n(7),
			i = n(8),
			l = n(10),
	...
	default = function(t) {
		...
		e.parseCss = function(t, e, n, i, l) {
			...
			var c = ["left", "right", "center", "justify"]; - 1 !== c.indexOf(i.textAlign) && (a.halign = i.textAlign), -1 !== (c = ["middle", "bottom", "top"]).indexOf(i.verticalAlign) && (a.valign = i.verticalAlign);
	...
	default = function(t, e, n, r) {
			for (var i = function(e) {
				e && "object" != typeof e && console.error("The options parameter should be of type object, is: " + typeof e), void 0 !== e.extendWidth && (e.tableWidth = e.extendWidth ? "auto" : "wrap", console.error("Use of deprecated option: extendWidth, use tableWidth instead.")), void 0 !== e.margins && (void 0 === e.margin && (e.margin = e.margins), console.error("Use of deprecated option: margins, use margin instead.")), e.startY && "number" != typeof e.startY && (console.error("Invalid value for startY option", e.startY), delete e.startY), !e.didDrawPage && (e.afterPageContent || e.beforePageContent || e.afterPageAdd) && (console.error("The afterPageContent, beforePageContent and afterPageAdd hooks are deprecated. Use didDrawPage instead"), e.didDrawPage = function(n) {
					...
					["padding", "cellPadding"],
					["lineHeight", "rowHeight"], "fontSize", "overflow"].forEach((function(t) {
		...
		var o = function(t, e, n) {
			...
			for (var o = e.settings.margin, r = t.pageSize().width - (o.left + o.right), i = [], l = [], a = e.columns.length, s = n && n.start ? n.start : 0; s < a;) {
				var u = e.columns[s].wrappedWidth;
				if (r < u) {
					0 !== s && s !== n.start || (i.push(s), l.push(e.columns[s]));
					break
				}
				i.push(s), l.push(e.columns[s]), r -= u, s++
			}
			return {
				colIndexes: i,
				columns: l
		...
		e.
	default = {
			getColumnsCanFitInPage: o,
			calculateAllColumnsCanFitInPage: function(t, e) {
				for (var n = [], r = 0, i = e.columns.length; r < i;) {
					var l = o(t, e, {
						start: 0 === r ? 0 : r
					});
					
					l && l.columns && l.columns.length ? (r += l.columns.length, n.push(l)) : r++
				}
				return n
			}
		}
		...
		e.calculateWidths = function(t, e) {
				...
				e.allRows().forEach((function(r) {
					for (var i = 0, l = e.columns; i < l.length; i++) {
						...
						if (s) {
							...
							if (s.minReadableWidth = c + s.padding("horizontal"), "number" == typeof s.styles.cellWidth) s.minWidth = s.styles.cellWidth, s.wrappedWidth = s.styles.cellWidth;
			...
			a && (a = r(n, a, (function(t) {
				...
				return t.minWidth
			}))), a = Math.abs(a), !e.settings.horizontalPageBreak && a > .1 / t.scaleFactor() && (a = a < 1 ? a : Math.round(a), console.error("Of the table content, " + a + " units width could not fit page")), function(t) {
				...
				for (var n = {
					...
					for (var l = r[o], a = 0, s = t.columns; a < s.length; a++) {
						...
						if (d) {
							...
							}): "ellipsize" === d.styles.overflow ? d.text = i(d.text, c, d.styles, e, "...") : "hidden" === d.styles.overflow ? d.text = i(d.text, c, d.styles, e, "") : "function" == typeof d.styles.overflow && (d.text = d.styles.overflow(d.text, c)),
							d.contentHeight = d.getContentHeight(e.scaleFactor());
							var h = d.contentHeight / d.rowSpan;d.rowSpan > 1 && n.count * n.height < h * d.rowSpan ? n = {
								height : h, count: d.rowSpan
							}: n && n.count > 0 && n.height > h && (h = n.height),
							h > l.height && (l.height = h)
						}
					}
					n.count--
				}
